// optionsBuilder.UseSqlServer(@"Server=DESKTOP-8020TLA;Database=eReconciliationDb;Integrated Security=true");
...
namespace DataAccess.Concrete.EntityFramework.Context
{
    public class ContextDb : DbContext
    {
       ...
       //public DbSet<ForgotPassword> ForgotPasswords { get; set; }
        //public DbSet<UserRelationShip> UserReletionships { get; set; }
